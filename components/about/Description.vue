<template>
  <div class="card bordered">
    <div class="card-body py-5 px-4 text-center">
      ...
      <p>
        Saya juga seorang Freelance Web Developer bersama dengan teman saya di <a href="https://evdigi.my.id/" target="blank">Byan Tech (Evdigi)</a>, namun untuk saat ini saya sedang bekerja sebagai fulltime Backend Developer di <a href="http://www.yubiteck.com/" target="_blank">PT Yubi Technology</a>.
      </p>
      ...
      <p>
        ...
        <a href="https://www.javascript.com/" target="blank">Javascript</a> jika diperlukan.
        selain itu
        <a href="https://git-scm.com/" target="blank">Git</a> dan
        <a href="https://github.com/" target="blank">GitHub</a> juga menjadi teknologi lain yang sering saya gunakan.
      </p>
